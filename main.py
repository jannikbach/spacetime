...
def main():
    ...
    def visualize_and_log(key, context, predicted_output, ground_truth,  context_length, prediction_length, plot_count, logger=None):
    ...
    ground_truth3 = total_y['test']['true'][0],
    ground_truth2 = total_y['test']['true_informer'].numpy(),
